#WARNING
This version is only for demonstrating the script in order to resolve a bug. To test the script correctly, you need to edit worker.py by adding your absolute path to grabcolor.py on line 9.
